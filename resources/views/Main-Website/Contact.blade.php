                ...
                <div class="content">
                    ...
                    <form class="content-form" id="contact-form" method="post"> 
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" name="Phone No" placeholder="Phone No" required=""></div>
